...
const reviewSchema = new mongoose.Schema({
  ...
  highlight: { type: Boolean, default: false }, // <-- Added missing field
  date: { type: String } // <-- Added missing field
}, { _id: false });
...
const defaultReviews = [
  ...
  { id: "2", name: "David Chen", role: "Enthusiast", text: "Their drone repair lab saved my custom FPV drone. Expert technicians.", rating: 5, image: "https://i.pravatar.cc/150?u=david", category: "Repairs", tags: ["Quick Service"], featured: false, highlight: false },
  { id: "3", name: "Marcus Thorne", role: "Hobbyist", text: "The selection of STEM toys is unmatched. Engineering principles through play.", rating: 5, image: "https://i.pravatar.cc/150?u=marcus", category: "Education", tags: ["STEM Learning"], featured: false, highlight: false },
  { id: "4", name: "Elena Rodriguez", role: "Collector", text: "Personal Shopper service was a godsend. Found the perfect age-appropriate gift.", rating: 5, image: "https://i.pravatar.cc/150?u=elena", category: "Shopping", tags: ["Bespoke"], featured: true, highlight: false },
];
